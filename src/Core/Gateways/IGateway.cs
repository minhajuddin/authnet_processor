namespace Authnet.Gateways {
    public interface IGateway {
        ...
        Response Refund(IProfileAttributes profileAttributes, IPaymentProfileAttributes paymentProfileAttributes, decimal amount, ITransaction transaction);//should probably take something else, maybe a payment identifier or something
